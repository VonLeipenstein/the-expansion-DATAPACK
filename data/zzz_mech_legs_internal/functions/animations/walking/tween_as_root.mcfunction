execute unless score #tween_duration aj.i = #tween_duration aj.i run scoreboard players operation #tween_duration aj.i = $aj.default_interpolation_duration aj.i
