...
scoreboard objectives add aj.mech_legs.animation.walking_backwards.local_anim_time dummy
scoreboard objectives add aj.mech_legs.animation.idle.local_anim_time dummy
scoreboard objectives add aj.mech_legs.animation.walking.loop_mode dummy
scoreboard objectives add aj.mech_legs.animation.walking_backwards.loop_mode dummy
scoreboard objectives add aj.mech_legs.animation.idle.loop_mode dummy
scoreboard players set $aj.mech_legs.animation.walking aj.id 0
scoreboard players set $aj.mech_legs.animation.walking_backwards aj.id 1
scoreboard players set $aj.mech_legs.animation.idle aj.id 2
scoreboard players set $aj.mech_legs.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.mech_legs.export_version aj.i -1298271510
