...
tp @s ~ ~ ~ ~ ~
execute at @s on passengers run function animated_java:mech_legs/zzzzzzzz/summon/as_rig_entities
execute if score #variant aj.i = $aj.mech_legs.variant.default aj.id run function animated_java:mech_legs/zzzzzzzz/apply_variant/default/as_root
