...
execute if score @s aj.mech_torso.animation.sword_swing_r.local_anim_time matches 40.. run function animated_java:mech_torso/zzzzzzzz/animations/sword_swing_r/end