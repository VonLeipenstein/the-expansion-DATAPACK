...
# spaceship
execute if block ~ ~ ~ minecraft:barrel{Items:[{Slot:3b,id:"minecraft:jigsaw",tag:{spaceship_nose:1b},Count:1b},{Slot:11b,id:"minecraft:jigsaw",tag:{spaceship_left_wing:1b},Count:1b},{Slot:12b,id:"minecraft:jigsaw",tag:{spaceship_cockpit:1b},Count:1b},{Slot:13b,id:"minecraft:jigsaw",tag:{spaceship_right_wing:1b},Count:1b},{Slot:21b,id:"minecraft:jigsaw",tag:{spaceship_engines:1b},Count:1b}]} run loot replace entity @s weapon.mainhand loot expansion:vehicles/spaceship
execute if block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b,id:"minecraft:jigsaw",tag:{spaceship_nose:1b},Count:1b},{Slot:10b,id:"minecraft:jigsaw",tag:{spaceship_left_wing:1b},Count:1b},{Slot:11b,id:"minecraft:jigsaw",tag:{spaceship_cockpit:1b},Count:1b},{Slot:12b,id:"minecraft:jigsaw",tag:{spaceship_right_wing:1b},Count:1b},{Slot:20b,id:"minecraft:jigsaw",tag:{spaceship_engines:1b},Count:1b}]} run loot replace entity @s weapon.mainhand loot expansion:vehicles/spaceship
# railgun
...
# pet drone
execute if block ~ ~ ~ minecraft:barrel{Items:[{Slot:2b,id:"minecraft:jigsaw",tag:{amethonium_ingot:1b},Count:1b},{Slot:3b,id:"minecraft:jigsaw",tag:{amethonium_ingot:1b},Count:1b},{Slot:10b,id:"minecraft:jigsaw",tag:{monochrome_monitor:1b},Count:1b},{Slot:11b,id:"minecraft:jigsaw",tag:{ai_core:1b},Count:1b},{Slot:12b,id:"minecraft:jigsaw",tag:{circuit_board:1b},Count:1b},{Slot:13b,id:"minecraft:jigsaw",tag:{amethonium_ingot:1b},Count:1b},{Slot:20b,id:"minecraft:jigsaw",tag:{amethonium_ingot:1b},Count:1b},{Slot:21b,id:"minecraft:jigsaw",tag:{amethonium_ingot:1b},Count:1b}]} run loot replace entity @s weapon.mainhand loot expansion:tools/pet_drone
