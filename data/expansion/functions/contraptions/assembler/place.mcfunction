...
execute as @e[type=minecraft:item_display,tag=exp.assembler_display,limit=1,sort=nearest] at @s run summon minecraft:armor_stand ^ ^ ^1 {Silent:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,Invisible:1b,Rotation:[90f,0f],DisabledSlots:2039583,Tags:["exp.assembler","exp.block","smithed.block"]}
