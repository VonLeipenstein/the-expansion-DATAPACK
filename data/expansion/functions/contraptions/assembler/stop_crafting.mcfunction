...
#item replace entity 
#data merge entity @e[type=item_display,tag=exp.assembler_display,limit=1,sort=nearest] {item:{id:"minecraft:jigsaw",Count:1b,tag:{CustomModelData:124402,display:{Name:'{"text":""}'}}}}
