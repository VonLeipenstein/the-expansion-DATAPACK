...
schedule function expansion:contraptions/portal/teleport/schedule_tp_tag 1t
...
execute if score @s[tag=!exp.teleported,predicate=expansion:dimension/scale_1] exp.dim_test matches 0..6 run function expansion:contraptions/portal/teleport/tp_scale_1
execute if score @s[tag=!exp.teleported,predicate=expansion:dimension/scale_10] exp.dim_test matches 7..8 run function expansion:contraptions/portal/teleport/tp_scale_10
execute if score @s[tag=!exp.teleported,predicate=expansion:dimension/scale_1] exp.dim_test matches 0..6 run function expansion:contraptions/portal/teleport/tp_scale_10_to_1
execute if score @s[tag=!exp.teleported,predicate=expansion:dimension/scale_10] exp.dim_test matches 7..8 run function expansion:contraptions/portal/teleport/tp_scale_1_to_10
