...
summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,Tags:["teleport_carrier"]}

# Proceed to the next step of teleportation.
execute as @e[type=armor_stand,tag=teleport_carrier,limit=1,sort=nearest] run function expansion:contraptions/portal/teleport/teleportation_stage_2