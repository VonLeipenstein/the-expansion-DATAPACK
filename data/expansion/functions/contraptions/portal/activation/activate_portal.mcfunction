...
execute unless score @s exp.counter_1 matches 0.. run function expansion:contraptions/portal/activation/assign_id

# create the portal array and 'upload' it to the global portal array
function expansion:contraptions/portal/activation/create_array
