...
execute positioned ^ ^ ^2 as @e[type=minecraft:armor_stand,tag=exp.core_port,limit=1,sort=nearest] if entity @s[nbt={ArmorItems:[{},{},{},{id:"minecraft:jigsaw",Count:1b,tag:{portal_core:1b}}]}] run function expansion:contraptions/portal/cores/take_core
