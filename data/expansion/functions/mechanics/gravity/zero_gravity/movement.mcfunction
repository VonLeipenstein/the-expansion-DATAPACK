...
execute if entity @s[scores={exp.sneak_delay=4},x_rotation=-90..-0.1] run function expansion:mechanics/gravity/zero_gravity/ascend
execute if entity @s[scores={exp.sneak_delay=4},x_rotation=0..90] run function expansion:mechanics/gravity/zero_gravity/descend