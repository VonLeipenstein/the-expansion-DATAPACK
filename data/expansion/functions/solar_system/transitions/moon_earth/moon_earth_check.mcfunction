...
execute if entity @s[predicate=expansion:nbt_checks/root_vehicle/return_capsule] run function expansion:solar_system/transitions/moon_earth/earth_success