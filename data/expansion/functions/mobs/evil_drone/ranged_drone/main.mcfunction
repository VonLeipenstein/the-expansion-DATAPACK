...
execute unless entity @p[distance=..7] anchored eyes facing entity @p eyes positioned ^ ^ ^2 rotated as @s positioned ^ ^ ^8 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^.25 ~ ~
...
execute if score @s exp.timer_1 matches 60 run function expansion:mobs/evil_drone/ranged_drone/fire