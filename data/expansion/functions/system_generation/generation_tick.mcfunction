execute if score #earth exp.timer_2 matches 1.. positioned 0 512 0 run function expansion:system_generation/earth_generation/load_earth
execute if score #moon exp.timer_2 matches 1.. positioned -621 512 126 run function expansion:system_generation/moon_generation/load_moon
execute if score #mars exp.timer_2 matches 1.. positioned -1882 512 -1334 run function expansion:system_generation/mars_generation/load_mars
execute if score #venus exp.timer_2 matches 1.. positioned 1358 512 1741 run function expansion:system_generation/venus_generation/load_venus
#execute if score #mercury exp.timer_2 matches 1.. positioned 2448 512 -1605 run function expansion:system_generation/mercury_generation/load_mercury
execute if score #jupiter exp.timer_2 matches 1.. positioned -2873 512 1536 run function expansion:system_generation/jupiter_generation/load_jupiter
execute if score #europa exp.timer_2 matches 1.. positioned -3557 512 1635 run function expansion:system_generation/europa_generation/load_europa
