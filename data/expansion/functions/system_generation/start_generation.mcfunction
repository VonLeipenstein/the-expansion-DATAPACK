...
execute at @p[tag=exp.generator] run summon minecraft:armor_stand ~ ~ ~ {Tags:["exp.player_spawn"],NoGravity:1b,Invisible:1b,Marker:1b}
...
schedule function expansion:system_generation/schedule_loop 100t append