...
execute if score #reload exp.delay matches 10 if score #total_system exp.gen_success matches 0 run function expansion:system_generation/start_generation
