execute at @e[type=minecraft:armor_stand,tag=exp.return_capsule,limit=1,sort=nearest] run summon minecraft:interaction ~ ~ ~ {Tags:["exp.capsule_rcdet","smithed.block"],width:2f,height:2f,response:1b}
