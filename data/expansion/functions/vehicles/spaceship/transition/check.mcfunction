...
execute if entity @s[tag=!exp.trying_transition,tag=!exp.summoned_new_ship,tag=exp.spaceship_pilot] at @s if loaded ~ ~ ~ run function expansion:vehicles/spaceship/transition/summon_new
