...
execute if entity @s[tag=!exp.summoned_new_ship,tag=exp.spaceship_pilot] if loaded ~ ~ ~ summon armor_stand run function expansion:vehicles/spaceship/transition/summon_new/base
