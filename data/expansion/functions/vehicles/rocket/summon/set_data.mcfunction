...
execute on passengers if entity @s[type=minecraft:item_display,tag=exp.rocket_display] run item replace entity @s container.0 with minecraft:carrot_on_a_stick{CustomModelData:1012000} 1
