...
execute at @e[type=minecraft:armor_stand,tag=exp.lunar_module,distance=..7,limit=1,sort=nearest] run summon minecraft:armor_stand ~ ~ ~ {Small:1b,Invisible:1b,Invulnerable:1b,Tags:["exp.module_seat"]}
