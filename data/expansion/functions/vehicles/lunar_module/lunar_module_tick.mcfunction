execute if entity @s[predicate=expansion:dimension/moon] on vehicle on vehicle at @s run function expansion:vehicles/lunar_module/inside
...
execute if entity @s[tag=exp.landing_moon] on vehicle on vehicle at @s run function expansion:vehicles/lunar_module/landing
