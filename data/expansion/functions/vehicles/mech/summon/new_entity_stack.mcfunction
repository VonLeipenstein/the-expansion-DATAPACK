...
summon minecraft:armor_stand ^ ^ ^ {Silent:1b,Small:0b,Invisible:0b,DisabledSlots:2039583,Invulnerable:1b,Rotation:[270f,0f],Tags:["exp.mech","exp.new_vehicle","exp.vehicle","smithed.block"],Passengers:[{id:"minecraft:cat",Tags:["exp.mech_seat"]},{id:"minecraft:interaction",Tags:["exp.mech_rcdet","smithed.block"],width:2,height:2f,response:0b}]}
