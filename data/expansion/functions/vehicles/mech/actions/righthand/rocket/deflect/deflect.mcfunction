...
execute unless score @e[tag=exp.mech_pilot,limit=1,sort=nearest] exp.unique_id matches 1.. run function expansion:vehicles/mech/actions/righthand/rocket/target/give_target_score
