...
data merge entity @s {item:{id:"minecraft:jigsaw",Count:1b,tag:{CustomModelData:123494}},teleport_duration:1,transformation:{scale:[1.0f,1.0f,1.0f],translation:[0.0f,0.5f,0.0f]}}
