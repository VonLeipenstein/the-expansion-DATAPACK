...
execute at @s[tag=!exp.trying_transition] run summon armor_stand ~ ~ ~ {NoGravity:0b,Invisible:1b,Tags:["exp.return_capsule","exp.vehicle","smithed.block"],DisabledSlots:2039583,ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{Unbreakable:1b,CustomModelData:1012007,return_capsule:1b}}]}
...
ride @s mount @e[type=armor_stand,tag=exp.return_capsule,limit=1,sort=nearest]
