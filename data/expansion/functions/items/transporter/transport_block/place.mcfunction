...
execute as @e[type=minecraft:marker,tag=exp.ray,distance=..5,limit=1,sort=nearest] at @s align xyz positioned ~.5 ~ ~.5 run summon minecraft:armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,Tags:["exp.transporter","exp.room_origin"]}
