...
execute unless predicate expansion:utility/sneak run tag @e[type=armor_stand,tag=!exp.searching_structure,tag=exp.pet_drone,limit=1,sort=nearest] add exp.searching_structure
