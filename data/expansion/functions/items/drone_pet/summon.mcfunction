summon minecraft:armor_stand ~ ~1 ~ {Silent:1b,Marker:1b,Invisible:1b,Small:1b,Tags:["exp.pet_drone"],CustomName:'{"text":"Scanner Drone"}',Passengers:[{id:"minecraft:interaction",Tags:["exp.pet_drone_rcdet"],response:1b,width:0.5f,height:0.5f}]}
