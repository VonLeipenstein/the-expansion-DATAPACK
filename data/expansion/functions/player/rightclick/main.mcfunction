...
execute if predicate expansion:nbt_checks/selected_item/blocks/block unless entity @s[tag=exp.inside_vehicle] anchored eyes if block ~ ~ ~ #expansion:expansion_airliq run function expansion:player/rightclick/place_blocks
