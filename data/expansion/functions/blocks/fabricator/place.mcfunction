summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:0b,Invisible:1b,Tags:["exp.fabricator","exp.block","smithed.block"],DisabledSlots:2039583,Passengers:[{id:"minecraft:item_display",Tags:["exp.fabricator_display"],item:{id:"minecraft:jigsaw",Count:1b,tag:{CustomModelData:123460}}}],Rotation:[90f,0f]}
