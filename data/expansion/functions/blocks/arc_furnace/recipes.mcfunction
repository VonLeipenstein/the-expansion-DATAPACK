...
# amethonium ingot
execute if block ~ ~ ~ minecraft:dropper{Items:[{Slot:0b,id:"minecraft:jigsaw",tag:{raw_titanium:1b}},{Slot:2b,id:"minecraft:amethyst_shard"}]} run loot replace entity @s weapon.mainhand loot expansion:items/materials/amethonium_ingot
execute if block ~ ~ ~ minecraft:dropper{Items:[{Slot:2b,id:"minecraft:jigsaw",tag:{raw_titanium:1b}},{Slot:0b,id:"minecraft:amethyst_shard"}]} run loot replace entity @s weapon.mainhand loot expansion:items/materials/amethonium_ingot
