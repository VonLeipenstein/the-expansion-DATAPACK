...
# melting
execute unless data entity @s ArmorItems[0].Count if block ~ ~ ~ minecraft:dropper{Items:[{Slot:0b},{Slot:2b}]} unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:7b,Count:64b}]} run function expansion:blocks/arc_furnace/recipes
