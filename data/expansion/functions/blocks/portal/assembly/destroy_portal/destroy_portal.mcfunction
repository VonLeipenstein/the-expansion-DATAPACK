...
execute as @e[type=minecraft:armor_stand,tag=exp.port_1,distance=..3,limit=1,sort=nearest] at @s run function expansion:blocks/portal/assembly/destroy_portal/retrieve_cores
execute as @e[type=minecraft:armor_stand,tag=exp.port_2,distance=..3,limit=1,sort=nearest] at @s run function expansion:blocks/portal/assembly/destroy_portal/retrieve_cores
execute as @e[type=minecraft:armor_stand,tag=exp.port_3,distance=..3,limit=1,sort=nearest] at @s run function expansion:blocks/portal/assembly/destroy_portal/retrieve_cores
