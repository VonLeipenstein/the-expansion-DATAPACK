...
execute unless entity @s[tag=exp.has_oxygen] if entity @e[type=marker,tag=exp.oxygen_marker,distance=..1,limit=1,sort=nearest] run function expansion:blocks/oxygenator/give_oxygen
