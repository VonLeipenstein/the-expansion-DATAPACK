execute unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:0b}]} run item replace block ~ ~ ~ container.0 with minecraft:jigsaw{CustomModelData:124400,display:{Name:'{"text":""}'},gui_item:1b}
execute unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:1b}]} run item replace block ~ ~ ~ container.1 with minecraft:jigsaw{CustomModelData:124401,display:{Name:'{"text":""}'},gui_item:1b}
...
execute unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:8b}]} run item replace block ~ ~ ~ container.8 with minecraft:jigsaw{CustomModelData:124401,display:{Name:'{"translate":"exp_blocks_guitip_info","italic": false,"color": "white"}',Lore:['{"translate":"exp_blocks_compressor_guitip1","italic": false,"color": "white"}','{"translate":"exp_blocks_compressor_guitip2","italic": false,"color": "white"}']},gui_item:1b}
