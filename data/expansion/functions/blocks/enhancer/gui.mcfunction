...
execute unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:1b}]} run item replace block ~ ~ ~ container.1 with minecraft:jigsaw{CustomModelData:124402,display:{Name:'{"text":""}'},gui_item:1b}
...
execute unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:4b}]} run item replace block ~ ~ ~ container.4 with minecraft:jigsaw{enhancer_button:1b,CustomModelData:124401,display:{Name:'{"text":"Apply Upgrade","italic": false,"color": "green"}'},gui_item:1b}
