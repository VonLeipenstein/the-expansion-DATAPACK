execute if predicate expansion:nbt_checks/selected_item/blocks/rocket_bottom run summon minecraft:armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,Tags:["exp.rocket_part","exp.block","smithed.block"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{rocket_bottom:1b,CustomModelData:1012299}}]}
execute if predicate expansion:nbt_checks/selected_item/blocks/rocket_cockpit run summon minecraft:armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,Tags:["exp.rocket_part","exp.block","smithed.block"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{rocket_cockpit:1b,CustomModelData:1012298}}]}
execute if predicate expansion:nbt_checks/selected_item/blocks/rocket_top run summon minecraft:armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,NoGravity:1b,Invisible:1b,Tags:["exp.rocket_part","exp.block","smithed.block"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{rocket_top:1b,CustomModelData:1012297}}]}
