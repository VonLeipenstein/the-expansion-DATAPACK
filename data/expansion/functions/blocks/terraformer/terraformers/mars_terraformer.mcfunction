...
execute at @e[type=area_effect_cloud,tag=exp.terraformer,limit=1,sort=nearest] if predicate expansion:light/8_15_light run function expansion:blocks/terraformer/terraformers/mars_plant_placer