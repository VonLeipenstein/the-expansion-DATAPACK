execute unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:0b}]} run item replace block ~ ~ ~ container.0 with minecraft:jigsaw{CustomModelData:124401,tree_button:1b,display:{Name:'{"text":"Terraform Land","color":"white","italic": false}'},gui_item:1b}
...
execute unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:3b}]} run item replace block ~ ~ ~ container.3 with minecraft:jigsaw{CustomModelData:124401,cube_button:1b,display:{Name:'{"text":"Cube Mode","color":"white","italic": false}'},gui_item:1b}
...
execute unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:6b}]} run item replace block ~ ~ ~ container.6 with minecraft:jigsaw{CustomModelData:124401,particle_button:1b,display:{Name:'{"text":"Particles","color":"white","italic": false}'},gui_item:1b}
