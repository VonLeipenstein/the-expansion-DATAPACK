...
execute unless block ~ ~ ~ minecraft:dropper{Items:[{Slot:6b}]} run item replace block ~ ~ ~ container.6 with minecraft:jigsaw{CustomModelData:124401,particle_button:1b,display:{Name:'{"translate":"exp_blocks_terraformer_button_particles","color":"white","italic": false}'},gui_item:1b}
