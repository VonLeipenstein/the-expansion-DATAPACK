...
execute if data entity @s ArmorItems[3].tag.ModStorage.righthand.tag.rocket run function expansion:vehicles/mech/actions/righthand/equip/rocket
execute if data entity @s ArmorItems[3].tag.ModStorage.righthand.tag.drill run function expansion:vehicles/mech/actions/righthand/equip/drill
...
execute if data entity @s ArmorItems[3].tag.ModStorage.lefthand.tag.rocket run function expansion:vehicles/mech/actions/lefthand/equip/rocket
execute if data entity @s ArmorItems[3].tag.ModStorage.lefthand.tag.drill run function expansion:vehicles/mech/actions/lefthand/equip/drill
