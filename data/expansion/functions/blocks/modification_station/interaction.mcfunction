...
execute unless entity @s[tag=exp.has_ship_selected] as @e[type=armor_stand,tag=exp.spaceship,distance=..50,limit=1,sort=nearest] run function expansion:blocks/modification_station/ship_selection/try_selection
