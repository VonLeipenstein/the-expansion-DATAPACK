...
execute if entity @s[tag=exp.has_ship_selected] unless entity @e[type=armor_stand,tag=exp.mod_ship,distance=..50,limit=1,sort=nearest] run function expansion:blocks/modification_station/deselect_ship
...
execute as @e[type=armor_stand,tag=exp.mod_drone,limit=5,sort=nearest] run function expansion:blocks/modification_station/mod_robots/main
