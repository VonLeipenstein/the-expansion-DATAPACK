...
scoreboard players operation exp.damage exp.durability *= #-2031 exp.durability
scoreboard players operation exp.damage exp.durability /= exp.max exp.durability
item modify entity @s weapon.mainhand expansion:custom_durability/update_dur_netherite
