...
execute as @s[tag=exp.rising] run function expansion:utilities/gravity/zero_gravity/rising
execute as @s[tag=exp.falling] run function expansion:utilities/gravity/zero_gravity/falling
