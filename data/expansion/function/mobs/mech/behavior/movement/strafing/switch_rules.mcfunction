...
# Callers for expansion:mobs/mech/behavior/movement/strafing/switch_rules
# Total callers: 1 from 1 source(s)
# Folder rule (function callers): 1/1 honored
# Sources:
# - function expansion:mobs/mech/behavior/movement/strafing/main (1 caller) [OK same-folder]
# <<< generated function callers <<<
