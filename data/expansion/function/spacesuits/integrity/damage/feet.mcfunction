...
# Callers for expansion:spacesuits/integrity/damage/feet
...
scoreboard players operation #temp exp.damage = #boots exp.damage
scoreboard players operation #temp exp.max_health = #boots exp.max_health
