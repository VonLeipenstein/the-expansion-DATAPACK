...
execute if score @s[tag=!exp.mech_walking_backwards] exp.mech_right_dur matches 1 on passengers if entity @s[type=minecraft:item_display,tag=aj.mech_torso.root] run function animated_java:mech_torso/animations/walking_right/stop
execute if score @s[tag=exp.mech_walking_backwards] exp.mech_right_dur matches 1 on passengers if entity @s[type=minecraft:item_display,tag=aj.mech_torso.root] run function animated_java:mech_torso/animations/walking_backwards_right/stop
