...
execute if score @s exp.mech_right_dur matches 15 store result score #temp exp.unique_id run data get entity @s ArmorItems[3].components.minecraft:custom_data.rocket_left_target
