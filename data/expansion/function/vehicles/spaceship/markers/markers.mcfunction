...
execute if entity @s[tag=exp.earth_marker] facing 0 128 0 run rotate @s ~ ~-10
execute if entity @s[tag=exp.moon_marker] facing -608 128 112 run rotate @s ~ ~-10
execute if entity @s[tag=exp.mars_marker] facing -1872 128 -1328 run rotate @s ~ ~-10
execute if entity @s[tag=exp.venus_marker] facing 1344 128 1728 run rotate @s ~ ~-10
execute if entity @s[tag=exp.jupiter_marker] facing -2864 128 1536 run rotate @s ~ ~-10
execute if entity @s[tag=exp.europa_marker] facing -3552 128 1632 run rotate @s ~ ~-10
execute if entity @s[tag=exp.asteroids_marker] facing -10000 128 ~ run rotate @s ~ ~-10
