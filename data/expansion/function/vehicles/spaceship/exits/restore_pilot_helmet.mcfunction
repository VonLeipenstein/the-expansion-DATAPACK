execute on vehicle run data modify entity @s equipment.mainhand set from entity @s data.ArmorStorage[0][0]
...
execute on vehicle run data remove entity @s data.ArmorStorage[0][0]
