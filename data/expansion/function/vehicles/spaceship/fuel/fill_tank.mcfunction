execute on passengers on target if entity @s[nbt={Inventory:[{id:"minecraft:potion",components:{"minecraft:custom_data":{lacrymae:1b}}}]}] run tag @s add exp.has_lacrymae
