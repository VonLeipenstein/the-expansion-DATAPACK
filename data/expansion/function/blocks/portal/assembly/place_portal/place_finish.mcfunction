...
summon minecraft:item_display ~ ~-1 ~ {Rotation:[0f,0f],Tags:["exp.portal_display"],item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_model_data":1012605},item_display:"head"}}
