...
function expansion:blocks/tesla_coil/coil/zap/cast

# damage the entities that have been shocked
execute as @e[tag=exp.zapped,distance=..10,limit=1,sort=nearest] at @s run function expansion:blocks/tesla_coil/coil/zap/damage