...
execute as @e[type=#expansion:sentient,tag=exp.inside_check,tag=!exp.has_oxygen,distance=..20] run function expansion:blocks/oxygenator/oxygenate/give_oxygen
