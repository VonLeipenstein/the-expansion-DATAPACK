...
# Callers for expansion:blocks/modification_station/upgrade/mech/selected
...
execute on passengers if entity @s[tag=exp.modstation.vehicle_link] on origin if entity @s[tag=exp.mech] run return 1
