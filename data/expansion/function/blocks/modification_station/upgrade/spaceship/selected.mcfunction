...
# Callers for expansion:blocks/modification_station/upgrade/spaceship/selected
...
execute on passengers if entity @s[tag=exp.modstation.vehicle_link] on origin if entity @s[tag=exp.spaceship] run return 1
