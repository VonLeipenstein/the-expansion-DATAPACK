...
execute on passengers if entity @s[tag=exp.rocket_diagnostics] run data merge entity @s {transformation:{translation:[-1.19,0.9,1.49],scale:[0.23,0.23,0.23],left_rotation:{axis:[0,1,0],angle:0.7854}}}
...
execute on passengers if entity @s[tag=exp.rocket_trip] run data merge entity @s {line_width:220,transformation:{translation:[1.19,0.9,1.49],scale:[0.23,0.23,0.23],left_rotation:{axis:[0,1,0],angle:-0.7854}}}
