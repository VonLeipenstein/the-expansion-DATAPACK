...
execute if items block ~ ~ ~ container.7 * unless function expansion:blocks/infuser/melting/compare_output run function expansion:blocks/arc_furnace/melting/start_melting
