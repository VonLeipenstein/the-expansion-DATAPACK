...
execute if score @s exp.bool matches 0 if items block ~ ~ ~ container.7 * run function expansion:blocks/arc_furnace/melting/add_product
execute if score @s exp.bool matches 0 unless items block ~ ~ ~ container.7 * run function expansion:blocks/arc_furnace/melting/insert_product
