...
execute at @s as @e[type=#expansion:wants_oxygen,tag=!exp.terraformer.ignore,tag=!exp.oxygenated,distance=0.5..39,limit=1] run function expansion:blocks/terraformer/oxygen_link/init
