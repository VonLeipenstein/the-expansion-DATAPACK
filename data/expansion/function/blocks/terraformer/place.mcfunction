summon minecraft:armor_stand ^ ^ ^ {Silent:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,Invisible:1b,Tags:["exp.terraformer","exp.block","smithed.block"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_model_data":1012301}}]}
summon minecraft:armor_stand ^ ^ ^ {Silent:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,Invisible:1b,Tags:["exp.shield_generator","exp.block","smithed.block"]}
