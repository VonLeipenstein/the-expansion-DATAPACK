...
# Callers for expansion:solar_system/transitions/from_space/to_earth/finish
# Total callers: 1 from 1 source(s)
# Folder rule (function callers): 1/1 honored
# Sources:
# - function expansion:solar_system/transitions/from_space/to_earth/prepare (1 caller) [OK same-folder]
# <<< generated function callers <<<
