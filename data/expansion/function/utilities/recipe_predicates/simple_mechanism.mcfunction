...
# Callers for expansion:utilities/recipe_predicates/simple_mechanism
...
execute if items block ~ ~ ~ container.1 *[custom_data~{exp_item:{name:"steel_ingot"}}] \
        if items block ~ ~ ~ container.2 *[custom_data~{exp_item:{name:"gear"}}] \
        unless items block ~ ~ ~ container.3 * \
        \
        if items block ~ ~ ~ container.10 *[custom_data~{exp_item:{name:"gear"}}] \
...
execute unless items block ~ ~ ~ container.1 * \
        ...
        if items block ~ ~ ~ container.3 *[custom_data~{exp_item:{name:"gear"}}] \
        \
        unless items block ~ ~ ~ container.10 * \
        if items block ~ ~ ~ container.11 *[custom_data~{exp_item:{name:"gear"}}] \
...
execute unless items block ~ ~ ~ container.1 * \
        ...
        unless items block ~ ~ ~ container.12 * \
        \
        if items block ~ ~ ~ container.19 *[custom_data~{exp_item:{name:"gear"}}] \
...
execute unless items block ~ ~ ~ container.1 * \
        ...
        unless items block ~ ~ ~ container.10 * \
        if items block ~ ~ ~ container.11 *[custom_data~{exp_item:{name:"steel_ingot"}}] \
        if items block ~ ~ ~ container.12 *[custom_data~{exp_item:{name:"gear"}}] \
        \
        unless items block ~ ~ ~ container.19 * \
        if items block ~ ~ ~ container.20 *[custom_data~{exp_item:{name:"gear"}}] \
