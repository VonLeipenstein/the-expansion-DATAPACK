...
# Callers for expansion:utilities/recipe_predicates/launch_pad
...
execute if items block ~ ~ ~ container.1 *[custom_data~{exp_item:{name:"monochrome_monitor"}}] \
        if items block ~ ~ ~ container.2 *[custom_data~{exp_item:{name:"monochrome_monitor"}}] \
        if items block ~ ~ ~ container.3 *[custom_data~{exp_item:{name:"monochrome_monitor"}}] \
        \
        if items block ~ ~ ~ container.10 *[custom_data~{exp_item:{name:"steel_ingot"}}] \
        if items block ~ ~ ~ container.11 *[custom_data~{exp_item:{name:"monochrome_monitor"}}] \
