...
execute if predicate expansion:armor/all if predicate expansion:dimension/oxygen_available run title @s subtitle {translate:"exp_screentxt_lowoxygen_subtitle_insuit"}
