...
execute on vehicle on vehicle on vehicle run title @p subtitle [{"translate":"exp_screentxt_rocket_fuelfail1"},{"score":{"name":"@s","objective":"exp.counter_1"}},{"translate":"exp_screentxt_rocket_fuelfail2"}]